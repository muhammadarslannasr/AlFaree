...
public class ShowDualNumberRecyclerViewAdapter extends RecyclerView.Adapter<ShowDualNumberRecyclerViewAdapter.ViewHolder>  {

    private List<DoubleNumber> doubleNumberList;
    private Context context;

    public ShowDualNumberRecyclerViewAdapter(List<DoubleNumber> doubleNumberList, Context context) {
    ...
    @NonNull
    @Override
    public ShowDualNumberRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dualnumber_row_updated,parent,false);
        return new ShowDualNumberRecyclerViewAdapter.ViewHolder(view,context);
    }

    @Override
    public void onBindViewHolder(@NonNull final ShowDualNumberRecyclerViewAdapter.ViewHolder holder, final int position) {
