...
import static com.thexsolution.propertyprojectf11.Activities.SaleReminderActivity.db;
import static com.thexsolution.propertyprojectf11.Activities.SaleReminderActivity.your_array_list_sale_reminder;

/**
 * Created by ArslanNasr on 5/26/2018.
 */

public class FilterSaleReminderRecyclerViewAdapter extends RecyclerView.Adapter<FilterSaleReminderRecyclerViewAdapter.ViewHolder> {
    ...
    private TextView main_textID,saleText;
    ...
    public FilterSaleReminderRecyclerViewAdapter(Context context, List<Reminder> surveyList,int value, String amount) {
    ...
    @NonNull
    @Override
    public FilterSaleReminderRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row,parent,false);
        return new FilterSaleReminderRecyclerViewAdapter.ViewHolder(view,context);
    }

    @Override
    public void onBindViewHolder(@NonNull FilterSaleReminderRecyclerViewAdapter.ViewHolder holder, int position) {

        Reminder reminder = reminderList.get(position);
        if (reminder.getRentorsaleId().equals(amount) && Integer.parseInt(reminder.getRentID()) >= rentlenght && Integer.parseInt(reminder.getRentID()) < value + 10) {
            ...
            holder.rent.setText("Sale:" + "\t" + "\t" + reminder.getRentID() + "\t" + reminder.getRentorsaleId());
            holder.number1.setText("Number 1:" + "\t" + reminder.getOwner_pd_numberID());

            holder.dateAdded.setText(reminder.getTimestamp());

            if (your_array_list_sale_reminder.contains(reminder.getRentReminder_nodeID())) {
        ...
        public ViewHolder(View itemView, final Context ctx) {
            ...
            favourites_images.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (your_array_list_sale_reminder.contains(reminder.getRentReminder_nodeID())) {
                        ...
                        your_array_list_sale_reminder.remove(reminder.getRentReminder_nodeID());
                        Toast.makeText(ctx, "UnDone!", Toast.LENGTH_SHORT).show();
                    } else if (!your_array_list_sale_reminder.contains(reminder.getRentReminder_nodeID())) {
                        ...
                        your_array_list_sale_reminder.add(reminder.getRentReminder_nodeID());
                ...
                public void onClick(View view) {
                    ...
                    dialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            int position = getAdapterPosition();
                            Reminder reminder = reminderList.get(position);
                            databaseReference = FirebaseDatabase.getInstance().getReference().child("SaleReminder").child(mUser.getUid()).child(reminder.getRentReminder_nodeID());
            ...
            editButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    saleText = view1.findViewById(R.id.saleText);
                    ...
                    main_textID.setText("Reminder Sale Updation Here!");
                    ...
                    mUser = mAuth.getCurrentUser();
                    mDatabaseReferrence = FirebaseDatabase.getInstance().getReference().child("SaleReminder").child(mUser.getUid()).child(reminder.getRentReminder_nodeID());
                    ...
                    submitbuttonId.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Toast.makeText(context, "Sale Reminder Updated!", Toast.LENGTH_SHORT).show();
