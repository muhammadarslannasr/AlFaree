...
public class GroupChatRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int VIEW_TYPE_MESSAGE_SENT = 1;
    private static final int VIEW_TYPE_MESSAGE_RECEIVED = 2;
    private Context context;
    private List<FriendlyMessage> data;
    private LayoutInflater inflater;
    private String userId;


    public GroupChatRecyclerViewAdapter(Context context, List<FriendlyMessage> data, String userId) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        FriendlyMessage message =  data.get(position);
    ...
    private class SentMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final FriendlyMessage message, int position) {
