...
public class SaleReminderRecyclerViewAdapter extends RecyclerView.Adapter<SaleReminderRecyclerViewAdapter.ViewHolder> {
    ...
    public SaleReminderRecyclerViewAdapter(Context context, List<Reminder> surveyList) {
    ...
    @NonNull
    @Override
    public SaleReminderRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row,parent,false);
        return new SaleReminderRecyclerViewAdapter.ViewHolder(view,context);
    }

    @Override
    public void onBindViewHolder(@NonNull SaleReminderRecyclerViewAdapter.ViewHolder holder, int position) {
