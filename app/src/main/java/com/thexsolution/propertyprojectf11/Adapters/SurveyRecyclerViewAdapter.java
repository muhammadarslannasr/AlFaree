...
import com.thexsolution.propertyprojectf11.Activities.RentUpdateActivity;
...
public class SurveyRecyclerViewAdapter extends RecyclerView.Adapter<SurveyRecyclerViewAdapter.ViewHolder> {
    ...
    public SurveyRecyclerViewAdapter(Context context, List<Survey> surveyList) {
    ...
    @NonNull
    @Override
    public SurveyRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.survey_row,parent,false);
        return new SurveyRecyclerViewAdapter.ViewHolder(view,context);
    }

    @Override
    public void onBindViewHolder(@NonNull SurveyRecyclerViewAdapter.ViewHolder holder, int position) {
            ...
            favourites_images.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (your_array_list.contains(survey.getSurvey_nodeID())) {
                        ...
                        your_array_list.remove(survey.getSurvey_nodeID());
                        Toast.makeText(ctx, "UnDone!", Toast.LENGTH_SHORT).show();
                    } else if (!your_array_list.contains(survey.getSurvey_nodeID())) {
                        ...
                        your_array_list.add(survey.getSurvey_nodeID());
