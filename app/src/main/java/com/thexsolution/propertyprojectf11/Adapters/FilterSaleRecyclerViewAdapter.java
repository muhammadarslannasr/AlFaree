...
import com.thexsolution.propertyprojectf11.Activities.InternalClickFullDataSaleActivity;
...
import static com.thexsolution.propertyprojectf11.Activities.SaleDataViewActivity.db;
import static com.thexsolution.propertyprojectf11.Activities.SaleDataViewActivity.your_array_list_Sale;
import static com.thexsolution.propertyprojectf11.Activities.SaleSurveySearchRecyclerViewActivity.your_array_list_rent_survey_10PLUS_10MINUS_sale;

/**
 * Created by ArslanNasr on 5/26/2018.
 */

public class FilterSaleRecyclerViewAdapter extends RecyclerView.Adapter<FilterSaleRecyclerViewAdapter.ViewHolder> {
    ...
    public FilterSaleRecyclerViewAdapter(Context context, List<Survey> surveyList, int value, String amount) {
    ...
    @NonNull
    @Override
    public FilterSaleRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.survey_row, parent, false);
        return new FilterSaleRecyclerViewAdapter.ViewHolder(view, context);
    }

    @Override
    public void onBindViewHolder(@NonNull FilterSaleRecyclerViewAdapter.ViewHolder holder, int position) {

        Survey survey = surveyList.get(position);
        if (survey.getRentorsaleId().equals(amount) && Integer.parseInt(survey.getRentID()) >= rentlenght && Integer.parseInt(survey.getRentID()) < value + 10000) {
            if (survey.getMobileSecondNumberID().isEmpty()) {
                holder.mobileNumberID2.setVisibility(View.GONE);
            } else {
                holder.mobileNumberID2.setText("Mobile Number 2:" + "\t" + survey.getMobileSecondNumberID());
            }
            holder.addressID.setText(survey.getSector_nameID() + "\t" + "\t" + "Street:" + "\t" + survey.getStreet_numberID() + "\t" + "House:" + "\t" + survey.getHouse_numberID());
            holder.rentID.setText("Demand:" + "\t" + survey.getRentID() + "\t" + survey.getRentorsaleId() + "/-");
            holder.ownerOrpropertyID.setText("Own/Prop:" + "\t" + survey.getOwnerorpropertyID());
            holder.mobileNumberID.setText("Mobile Number 1:" + "\t" + survey.getOwner_pd_numberID());

            holder.date.setText(survey.getTimestamp());

            if (your_array_list_rent_survey_10PLUS_10MINUS_sale.contains(survey.getSurvey_nodeID())) {
        ...
        public ViewHolder(View itemView, final Context ctx) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, InternalClickFullDataSaleActivity.class);
            ...
            favourites_images.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (your_array_list_rent_survey_10PLUS_10MINUS_sale.contains(survey.getSurvey_nodeID())) {
                        ...
                        your_array_list_rent_survey_10PLUS_10MINUS_sale.remove(survey.getSurvey_nodeID());
                        Toast.makeText(ctx, "UnDone!", Toast.LENGTH_SHORT).show();
                    } else if (!your_array_list_rent_survey_10PLUS_10MINUS_sale.contains(survey.getSurvey_nodeID())) {
                        ...
                        your_array_list_rent_survey_10PLUS_10MINUS_sale.add(survey.getSurvey_nodeID());
            ...
            shareBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT,
                            ...
                            +"\nDemand:"+ "\t" + survey.getRentID() + "\t" + survey.getRentorsaleId()
                            ...
                            +"\nFurnish:"+ "\t" + survey.getFullHouseCheckBoxId()
            ...
            editBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    View view1 = inflater.inflate(R.layout.activity_survey_update, null);
                    ...
                    bathID.setSelection(bathID.getText().length());
                    ...
                    mUser = mAuth.getCurrentUser();
                    mDatabaseReferrence = FirebaseDatabase.getInstance().getReference().child("SurveySaleData").child(mUser.getUid()).child(survey.getSurvey_nodeID());
                    ...
                    submitbuttonId.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            survey.setRentorsaleId(rentorsaleListSpinner);
                            data.put("furnishId",furnishListSpinner);
                            survey.setFurnishId(furnishListSpinner);
                ...
                public void onClick(View view) {
                    ...
                    dialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            databaseReference = FirebaseDatabase.getInstance().getReference().child("SurveySaleData").child(mUser.getUid()).child(s.getSurvey_nodeID());
