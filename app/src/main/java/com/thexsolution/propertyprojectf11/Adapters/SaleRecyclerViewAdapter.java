...
public class SaleRecyclerViewAdapter extends RecyclerView.Adapter<SaleRecyclerViewAdapter.ViewHolder> {
    ...
    public SaleRecyclerViewAdapter(Context context, List<Survey> surveyList) {
    ...
    @NonNull
    @Override
    public SaleRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SaleRecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        if(your_array_list_Sale.contains(survey.getSurvey_nodeID())){
            ...
            favourites_images.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (your_array_list_Sale.contains(survey.getSurvey_nodeID())) {
                        ...
                        your_array_list_Sale.remove(survey.getSurvey_nodeID());
                        Toast.makeText(ctx, "UnDone!", Toast.LENGTH_SHORT).show();
                    } else if (!your_array_list_Sale.contains(survey.getSurvey_nodeID())) {
                        ...
                        your_array_list_Sale.add(survey.getSurvey_nodeID());
