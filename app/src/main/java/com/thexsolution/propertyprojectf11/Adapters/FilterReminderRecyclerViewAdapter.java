...
public class FilterReminderRecyclerViewAdapter extends RecyclerView.Adapter<FilterReminderRecyclerViewAdapter.ViewHolder> {
    ...
    public FilterReminderRecyclerViewAdapter(Context context, List<Reminder> surveyList,int rent) {
        this.context = context;
        this.reminderList = surveyList;
        this.numberList = new ArrayList<>();
        this.rentVale = rent;
        rentlenght = rent-10000;
    }

    @NonNull
    @Override
    public FilterReminderRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row,parent,false);
        return new FilterReminderRecyclerViewAdapter.ViewHolder(view,context);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull FilterReminderRecyclerViewAdapter.ViewHolder holder, int position) {

        Reminder reminder = reminderList.get(position);
        if (Integer.parseInt(reminder.getRentID()) >= rentlenght && Integer.parseInt(reminder.getRentID()) < rentVale+10000){
