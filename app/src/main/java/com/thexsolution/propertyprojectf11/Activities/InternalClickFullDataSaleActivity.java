...
public class InternalClickFullDataSaleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (rentorsale.equals("Rent")){
            ...
            rentID.setText(rent + "\t" + rentorsale);
        }
        ...
        if (rentorsale.equals("Rent")){
            ...
            rentOrSale.setText("Demand");
            type.setText("Demand");
        }
        rentOrSaleID.setText(rentorsale);
        furnishId.setText("Amount:"+"\t"+furnish);
    ...
    public void onBackPressed() {
        ...
        InternalClickFullDataSaleActivity.this.finish();
    }
