...
public class SurveyRentActivity extends AppCompatActivity {
    ...
    public static final String ACTION_RENT_VALUE = "action_rent_value";
    public static final String ACTION_RENT_LENGTH = "action_rent_length";
    ...
    private FirebaseAuth mAuthFilterList;
    private FirebaseUser mUserFilterList;
    FirebaseDatabase mDatabaseFilterList;
    DatabaseReference mDatabaseReferrenceFilterList;
    private FilterReminderRecyclerViewAdapter filterReminderRecyclerViewAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_survey);
        init();
        getSupportActionBar().setTitle(Utility.getStringFromRes(SurveyRentActivity.this,R.string.survey));
...
//        rentID.addTextChangedListener(new TextWatcher() {
//            int len=0;
//            @Override
//            public void beforeTextChanged(CharSequence charSequence, int i, int i1, int i2) {
//
//                //Toast.makeText(SurveyRentActivity.this, "beforeTextChanged", Toast.LENGTH_SHORT).show();
//            }
//
//            @Override
//            public void onTextChanged(CharSequence charSequence, int i, int i1, int i2) {
//                String text = rentID.getText().toString();
//                if(text.length() == 2){
//                    rentID.append(",");
//                    Toast.makeText(SurveyRentActivity.this, rentID.getText().toString().trim(), Toast.LENGTH_SHORT).show();
//                }
//            }
//
//            @Override
//            public void afterTextChanged(Editable editable) {
//                //Toast.makeText(SurveyRentActivity.this, "afterTextChanged", Toast.LENGTH_SHORT).show();
//            }
//        });
        ...
        nextbuttonId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SurveyRentActivity.this,SurveyRentTwoActivity.class);
    ...
    private void addSurveyData() {
        ...
        dialogBuilder.setMessage(Utility.getStringFromRes(SurveyRentActivity.this,R.string.sure));
        dialogBuilder.setPositiveButton(Utility.getStringFromRes(SurveyRentActivity.this, R.string.yes), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(SurveyRentActivity.this,FilterListActivity.class);
...
//                newPost.setValue(data);
        ...
        dialogBuilder.setNegativeButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                data.put("descriptionID",descriptionID.getText().toString().trim());
                newPost.setValue(data);
                Toast.makeText(SurveyRentActivity.this, "Survey Added!", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        SurveyRentActivity.this.finish();
    }
