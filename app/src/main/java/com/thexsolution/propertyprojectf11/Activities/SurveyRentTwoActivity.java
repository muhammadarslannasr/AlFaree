...
public class SurveyRentTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        getSupportActionBar().setTitle(Utility.getStringFromRes(SurveyRentTwoActivity.this,R.string.next_survey));
        ...
        mDatabaseReferrence = FirebaseDatabase.getInstance().getReference().child("SurveyData").child(mUser.getUid());

        nextbuttonId.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

               startActivity(new Intent(SurveyRentTwoActivity.this,SurveyRentThreeActivity.class));
            }
        });
    ...
    private void addSurveyData() {
        ...
        dialogBuilder.setMessage(Utility.getStringFromRes(SurveyRentTwoActivity.this,R.string.sure));
        dialogBuilder.setPositiveButton(Utility.getStringFromRes(SurveyRentTwoActivity.this, R.string.yes), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {

                Intent intent = new Intent(SurveyRentTwoActivity.this,FilterListActivity.class);
                intent.putExtra(ACTION_RENT_VALUE,rentID.getText().toString().trim());
                startActivity(intent);
//                dialogOld.cancel();
//                dialogBuilder.setMessage("");
//                dialogBuilder1 = new android.support.v7.app.AlertDialog.Builder(SurveyRentActivity.this);
//                View view = getLayoutInflater().inflate(R.layout.reminder_rent_view, null);
//                RecyclerView recylerViewID = (RecyclerView) view.findViewById(R.id.filterListRecyclerViewID);
//
//                mAuthFilterList = FirebaseAuth.getInstance();
//                mUserFilterList = mAuthFilterList.getCurrentUser();
//                mDatabase = FirebaseDatabase.getInstance();
//                mDatabaseReferrenceFilterList = mDatabase.getReference().child("RentReminder").child(mUser.getUid());
//                mDatabaseReferrenceFilterList.keepSynced(true);
//                reminderList = new ArrayList<>();
//                recylerViewID.setHasFixedSize(true);
//                recylerViewID.setLayoutManager(new LinearLayoutManager(SurveyRentActivity.this));
//
//
//                final RecyclerView finalRecylerViewID = recylerViewID;
//                mDatabaseReferrenceFilterList.addChildEventListener(new ChildEventListener() {
//                    @Override
//                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
//                        Reminder reminder = dataSnapshot.getValue(Reminder.class);
//                        reminderList.add(reminder);
//                        Collections.reverse(reminderList);
//                        filterReminderRecyclerViewAdapter = new FilterReminderRecyclerViewAdapter(SurveyRentActivity.this, reminderList,rentID.getText().toString().trim());
//                        finalRecylerViewID.setAdapter(filterReminderRecyclerViewAdapter);
//                        filterReminderRecyclerViewAdapter.notifyDataSetChanged();
//                    }
//
//                    @Override
...
//            }
        ...
        dialogBuilder.setNegativeButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(SurveyRentTwoActivity.this, "Survey Added!", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        SurveyRentTwoActivity.this.finish();
    }
}
