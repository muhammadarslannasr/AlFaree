...
public class RentSurveySearchRecyclerViewActivity extends AppCompatActivity {
    ...
    SurveyRentRecyclerViewAdapter surveyRentRecyclerViewAdapter;
    public static SQLiteDatabase db;
    public static List<String> your_array_list_rent_survey_10PLUS_10MINUS;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rent_survey_search_recycler_view);
        connectionDetect = new ConnectionDetect(RentSurveySearchRecyclerViewActivity.this);
        ...
        rentRecyclerViewID.setLayoutManager(new LinearLayoutManager(RentSurveySearchRecyclerViewActivity.this));
...
//                                surveyRentRecyclerViewAdapter = new SurveyRentRecyclerViewAdapter(RentSurveySearchRecyclerViewActivity.this, surveyList, value);
...
//                    } else {
//                        progressDialog.dismiss();
//                        Toast.makeText(RentSurveySearchRecyclerViewActivity.this, "Data Not Available!", Toast.LENGTH_SHORT).show();
//                    }
//                }
//
//                @Override
...
//            progressDialog.show();
                        ...
                        //progressDialog.dismiss();
                        Toast.makeText(RentSurveySearchRecyclerViewActivity.this, "Turn on your Internet Connection!", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void saveFavouritesImaged() {
        ...
        try {
            your_array_list_rent_survey_10PLUS_10MINUS = new ArrayList<String>();
            ...
            if (c.getCount() != 0) {
                if (c.moveToFirst()) {
                    do {
                        your_array_list_rent_survey_10PLUS_10MINUS.add(c.getString(c.getColumnIndex("image")));
                    } while (c.moveToNext());
                }
    ...
    public void onBackPressed() {
        ...
        RentSurveySearchRecyclerViewActivity.this.finish();
    }
}
