...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView reset_btn_id,create_btn_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Utility.getStringFromRes(MainActivity.this,R.string.login_activity));


        reset_btn_id = findViewById(R.id.reset_btn_id);
        reset_btn_id.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        create_btn_id = findViewById(R.id.create_btn_id);
        create_btn_id.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
