...
public class SaleReminderActivity extends AppCompatActivity {
    ...
    private SaleReminderRecyclerViewAdapter rentReminderRecyclerViewAdapter;
    public static SQLiteDatabase db;
    public static List<String> your_array_list_sale_reminder;
    private ConnectionDetect connectionDetect;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sale_reminder);
        connectionDetect = new ConnectionDetect(SaleReminderActivity.this);
        getSupportActionBar().setTitle(Utility.getStringFromRes(SaleReminderActivity.this, R.string.sale_reminder));
        if (getSupportActionBar() != null) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setDisplayShowHomeEnabled(true);
        }
        db = openOrCreateDatabase("SaleReminderFavourites", Context.MODE_PRIVATE, null);
        ...
        rentReminderRecyclerViewID = (RecyclerView) findViewById(R.id.saleReminderRecyclerViewID);
        rentReminderRecyclerViewID.setHasFixedSize(true);
        rentReminderRecyclerViewID.setLayoutManager(new LinearLayoutManager(SaleReminderActivity.this));
...
//                                rentReminderRecyclerViewAdapter = new SaleReminderRecyclerViewAdapter(SaleReminderActivity.this, reminderList);
...
//                    } else {
//                        progressDialog.dismiss();
//                        Toast.makeText(SaleReminderActivity.this, "Data not Available!", Toast.LENGTH_SHORT).show();
//                    }
//                }
//
//                @Override
...
//            progressDialog.show();
    ...
    private void addSaleReminder() {

        dialogBuilder = new AlertDialog.Builder(this);
        View view = getLayoutInflater().inflate(R.layout.sale_reminder_dialog_add_layout, null);
        ...
        mDatabase = FirebaseDatabase.getInstance();
        mUser = mAuth.getCurrentUser();
        mDatabaseReferrence = FirebaseDatabase.getInstance().getReference().child("SaleReminder").child(mUser.getUid());
        ...
        submitbuttonId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(SaleReminderActivity.this, "Sale Reminder Added!", Toast.LENGTH_SHORT).show();
    ...
    private void saveFavouritesImaged() {
        ...
        try {
            your_array_list_sale_reminder = new ArrayList<String>();
            ...
            if (c.getCount() != 0) {
                if (c.moveToFirst()) {
                    do {
                        your_array_list_sale_reminder.add(c.getString(c.getColumnIndex("image")));
                    } while (c.moveToNext());
                }
