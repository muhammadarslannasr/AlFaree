...
public class SaleSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sale_second);
        init();
        getSupportActionBar().setTitle(Utility.getStringFromRes(SaleSecondActivity.this,R.string.sale_second));
        ...
        nextbuttonId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SaleSecondActivity.this,SaleThirdActivity.class);
    ...
    private void addSurveyData() {
        ...
        dialogBuilder.setMessage(Utility.getStringFromRes(SaleSecondActivity.this,R.string.sure));

        dialogBuilder.setPositiveButton(Utility.getStringFromRes(SaleSecondActivity.this, R.string.yes), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {

                Intent intent = new Intent(SaleSecondActivity.this,SaleReminderSurveyRecyclerViewActivity.class);
        ...
        dialogBuilder.setNegativeButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(SaleSecondActivity.this, "Survey Sale Added!", Toast.LENGTH_SHORT).show();
    ...
    public void furnishSpinner(){
        List<String> furnishList = new ArrayList<>();
        furnishList.add("Lakh");
        furnishList.add("Crore");
        furnishList.add("Arab");
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(getApplicationContext(),android.R.layout.simple_spinner_item,furnishList);
        arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void onBackPressed() {
        ...
        SaleSecondActivity.this.finish();
    }
}
