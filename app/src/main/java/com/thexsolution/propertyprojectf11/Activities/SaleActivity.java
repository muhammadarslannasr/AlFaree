...
public class SaleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        getSupportActionBar().setTitle(Utility.getStringFromRes(SaleActivity.this,R.string.survey_sale));
        ...
        nextbuttonId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SaleActivity.this,SaleSecondActivity.class);
    ...
    private void addSurveyData() {
        ...
        dialogBuilder.setMessage(Utility.getStringFromRes(SaleActivity.this,R.string.sure));

        dialogBuilder.setPositiveButton(Utility.getStringFromRes(SaleActivity.this, R.string.yes), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {

                Intent intent = new Intent(SaleActivity.this,SaleReminderSurveyRecyclerViewActivity.class);
        ...
        dialogBuilder.setNegativeButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(SaleActivity.this, "Survey Sale Added!", Toast.LENGTH_SHORT).show();
