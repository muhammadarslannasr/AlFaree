...
public class SurveyRentThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_rent_three);

        init();
        getSupportActionBar().setTitle(Utility.getStringFromRes(SurveyRentThreeActivity.this,R.string.next_survey_three));
    ...
    private void addSurveyData() {
        ...
        dialogBuilder.setMessage(Utility.getStringFromRes(SurveyRentThreeActivity.this,R.string.sure));
        dialogBuilder.setPositiveButton(Utility.getStringFromRes(SurveyRentThreeActivity.this, R.string.yes), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {

                Intent intent = new Intent(SurveyRentThreeActivity.this,FilterListActivity.class);
...
//            }
        ...
        dialogBuilder.setNegativeButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(SurveyRentThreeActivity.this, "Survey Rent Added!", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        SurveyRentThreeActivity.this.finish();
    }
}
