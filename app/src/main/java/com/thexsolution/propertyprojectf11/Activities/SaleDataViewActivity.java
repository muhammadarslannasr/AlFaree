...
public class SaleDataViewActivity extends AppCompatActivity {
    ...
    public static List<String> your_array_list_Sale;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sale_data_view);
        connectionDetect = new ConnectionDetect(SaleDataViewActivity.this);
        getSupportActionBar().setTitle(Utility.getStringFromRes(SaleDataViewActivity.this, R.string.survey_data_sale));
        if (getSupportActionBar() != null) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setDisplayShowHomeEnabled(true);
        }
        db = openOrCreateDatabase("FavouritesSale", Context.MODE_PRIVATE, null);
        ...
        rentRecyclerViewID.setLayoutManager(new LinearLayoutManager(SaleDataViewActivity.this));
...
//                                saleRecyclerViewAdapter = new SaleRecyclerViewAdapter(SaleDataViewActivity.this, surveyList);
//                                rentRecyclerViewID.setAdapter(saleRecyclerViewAdapter);
//                                saleRecyclerViewAdapter.notifyDataSetChanged();
//
...
//                    } else {
//                        progressDialog.dismiss();
//                        Toast.makeText(SaleDataViewActivity.this, "Data not Available", Toast.LENGTH_SHORT).show();
//                    }
//                }
//
//                @Override
...
//            progressDialog.show();
    ...
    private void saveFavouritesImaged() {
        ...
        try {
            your_array_list_Sale = new ArrayList<String>();
            ...
            if (c.getCount() != 0) {
                if (c.moveToFirst()) {
                    do {
                        your_array_list_Sale.add(c.getString(c.getColumnIndex("image")));
                    } while (c.moveToNext());
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                saleRecyclerViewAdapter.setfilter(filteredmodelist);
                return true;
            }
        });
    ...
    public void onBackPressed() {
        ...
        SaleDataViewActivity.this.finish();
    }
}
